...
import com.example.ourworldcup.aws.s3.metadata.FilePackageMetadata;
...
public abstract class FileProcessServiceImpl<T extends FilePackageMetadata> {
    ...
    public String uploadImage(MultipartFile file, T imagePackage) {
        ...
        try (InputStream inputStream = file.getInputStream()) {
            ...
            throw new IllegalArgumentException(String.format("파일 변환 중에 에러가 발생했습니다. (%s)", file.getOriginalFilename()));
        }
    ...
    protected String createValidOriginalFileName(String originalFileName) {
